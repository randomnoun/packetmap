...
namespace Tamir.IPLib.Packets
{
	...
	public class ARPPacket : EthernetPacket, ARPFields
	{
		...
		/// <summary> Fetch the hardware source address.</summary>
		public virtual System.String getARPSenderHwAddress()
		{
		...
		public virtual void setARPSenderHwAddress(System.String addr)
		{
			MACAddress.insert(addr, _ethOffset + ARPFields_Fields.ARP_S_HW_ADDR_POS, _bytes);
		}
		...
		public virtual System.String getARPTargetHwAddress()
		{
		...
		public virtual void setARPTargetHwAddress(System.String addr)
		{
			MACAddress.insert(addr, _ethOffset + ARPFields_Fields.ARP_T_HW_ADDR_POS, _bytes);
		}
		...
		public override System.String ToColoredString(bool colored)
		{
			...
			buffer.Append(' ');
			buffer.Append(getARPSenderHwAddress() + " -> " + getARPTargetHwAddress());
			buffer.Append(", ");
