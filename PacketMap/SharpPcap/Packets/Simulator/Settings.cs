...
{
	using System;
	using PropertyHelper = Tamir.IPLib.Packets.Util.PropertyHelper;
	...
	{
		public static System.String PROPERTY_PKG = "Tamir.IPLib.Packets.Simulator";
		...
		//UPGRADE_NOTE: The initialization of  'PATH_DEFAULTS' was moved to static method 'Tamir.IPLib.Packets.Simulator.Settings'. 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="jlca1005"'
